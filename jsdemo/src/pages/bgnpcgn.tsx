...
export default () => {
  ...
  return (
    <>
      ...
      <p><i>The systems listed here are ordered according to the "Introduction to Romanization Systems and Roman script spelling conventions (updated 25 September 2020)" document, available at <a href="https://geonames.nga.mil/gns/html/romanization.html" target="_blank">BGN </a>
      and <a href="https://www.gov.uk/government/publications/romanization-systems" target="_blank">PCGN</a>.</i></p>
