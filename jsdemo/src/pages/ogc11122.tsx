...
export default () => {
  ...
  return (
    <>
      ...
      <p><i>The systems listed here are ordered according to the "OGC 11-122r1 Gazetteer Service - Application Profile of the Web Feature Service Best Practice (1.0)" document, available
         &nbsp;<a href="https://www.ogc.org/standards/wfs" target="_blank">here</a>.</i></p>
