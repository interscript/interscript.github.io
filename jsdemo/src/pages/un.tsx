...
export default () => {
  ...
  return (
    <>
      ...
      <p><i>The systems listed here are ordered according to the <a href="https://unstats.un.org/unsd/geoinfo/UNGEGN/docs/10th-uncsgn-docs/Exhibition%20posters/WG%20on%20Romanization_4.pdf" target="_blank">Romanization examples</a> exhibition poster at the 10th UNCSGN conference, from the UNGEGN Working Group on Romanization Systems.</i></p>
