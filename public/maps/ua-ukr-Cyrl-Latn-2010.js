...
s = Interscript.gsub(s, "’", "");
s = Interscript.parallel_replace_tree(s, map.cache.PTREE_2182032279073619256);
s = Interscript.transliterate("ua-ukr-Cyrl-Latn-1996", s, "main");
return s;
};
map.cache.PTREE_2182032279073619256 = {"1168":{"":"G"},"1169":{"":"g"},"1065":{"":"Shch"},"1097":{"":"shch"},"1100":{"":""},"1068":{"":""},"39":{"":""},"8217":{"":""}};
