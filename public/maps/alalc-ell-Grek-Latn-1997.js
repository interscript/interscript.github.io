var map = function(Interscript) {Interscript.define_map("alalc-ell-Grek-Latn-1997", function(Interscript, map) {
map.dependencies = [];
map.aliases.greek_upper = "Ά";
map.aliases_re.greek_upper = "[ΆΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩΈΉΊΌΏΪΫ]";
...
s = Interscript.gsub(s, "υ(?=[Ιιί])", "u");
s = Interscript.gsub(s, "Γ(?=[γΓκΚξΞχΧ])", "N");
s = Interscript.gsub(s, "γ(?=[γΓκΚξΞχΧ])", "n");
