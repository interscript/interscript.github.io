...
s = Interscript.gsub(s, "(?<=[АаЕеЁёИиОоУуЭэЮюЯяЙйЬь])е", "ye");
s = Interscript.parallel_replace_tree(s, map.cache.PTREE_1960511456678456730);
s = Interscript.transliterate("bgnpcgn-uzb-Cyrl-Latn-1979", s, "main");
return s;
};
map.cache.PTREE_1960511456678456730 = {"1042":{"":"V"},"1170":{"":"G‘"},"1046":{"":"J"},"1038":{"":"O‘"},"1061":{"":"X"},"1066":{"":"’"},"1068":{"":"’"},"1074":{"":"w"},"1171":{"":"g‘"},"1078":{"":"j"},"1118":{"":"o‘"},"1093":{"":"x"},"1098":{"":"’"},"1100":{"":"’"}};
