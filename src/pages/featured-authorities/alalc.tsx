    ...
    return (
        <>
            ...
            <p>
                ...
                <a href="https://www.loc.gov/catdir/cpso/roman.html">ALA-LC Romanization Tables</a>", a set of
                Romanization systems covering many languages. These systems are commonly used in libraries and
                bibliographic data worldwide.
            </p>
            <p>
                Systems listed here follow the same order in the presentation of the original
