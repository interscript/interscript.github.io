    ...
    return (
        <>
            ...
            <p>
                ...
                <a href="https://www.gov.uk/government/publications/romanization-systems">
                    BGN/PCGN romanization systems
                </a>
                ", a set of script conversion systems widely relied upon for geographic name script conversions.
            </p>
            <p>
                Systems listed here are ordered according to the "Introduction to Romanization Systems and Roman script
                spelling conventions (updated 25 September 2020)" document, available at{" "}
